...
const (
	...
	GetGistByID       = `SELECT * FROM gists WHERE file_id = $1 and user_id = $2;`
	GetGistByShortURL = `SELECT * FROM gists WHERE short_url = $1 and user_id = $2;`
	GetGistsByUserID  = `SELECT * FROM gists WHERE user_id = $1  and user_id = $2;`
	InsertGist        = `INSERT INTO gists ( user_id, file_id, gist_title, short_url, is_public )
		VALUES ( $1, $2, $3, $4, $5 );`
